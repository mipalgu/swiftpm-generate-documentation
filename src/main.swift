...
#if os(macOS)
let swiftBinDefault = "/Users/runner/hostedtoolcache/swift-macOS/5.7/x64/usr/bin/swift"
#else
let swiftBinDefault = "/opt/hostedtoolcache/swift-Ubuntu/5.7/x64/usr/bin/swift"
#endif
